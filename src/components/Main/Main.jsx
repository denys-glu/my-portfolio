            ...
            <div className="card">
              ...
              <div className="card-body text-center">
                ...
                <div className="row social-network">
                  <div className="col-2"><i class="fab fa-linkedin-in"></i></div>
                  <div className="col-2"><i class="fab fa-github-square"></i></div>
                  <div className="col-2"><i class="fab fa-aws"></i></div>
                </div>
              </div>
            </div>
          </div>
