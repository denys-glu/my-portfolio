              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <div className="project-description mt-4">
                    ...
                    <ul class="list-group">
                      <li class="list-group-item">Geolocation service</li>
                      <li class="list-group-item">Push notification feature</li>
                      <li class="list-group-item">Multi account possibility</li>
                      <li class="list-group-item">Offline work</li>
                      <li class="list-group-item">Supports Android and iOS users (Ionic and Cordova) </li>
                    </ul>
                  </div>
          ...
          <div className="modal fade" id="exampleModal1" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog">
              <div className="modal-content">
                ...
                <div className="modal-footer">
                  <button type="button" className="btn btn-secondary" data-dismiss="modal">Close</button>
                  <a type="button" href="http://18.224.15.81/" target="_blank" className="btn btn-main" data-dismiss="modal">Try It!</a>
                </div>
              </div>
            </div>
          </div>
